      ...
      <Box sx={{ width: '100%', height: 300 }}>
        <ResponsiveContainer>
          <BarChart data={data} barGap={4} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            ...
            <XAxis dataKey="name" axisLine={false} tickLine={false} tick={{ fill: '#A0AEC0', fontSize: 12, fontWeight: 500 }} />
            ...
            <Legend verticalAlign="top" align="right" iconType="circle" iconSize={8} wrapperStyle={{ paddingBottom: '20px', fontSize: '14px', fontWeight: 500 }} />
            <Bar dataKey="doctors" name="Doctors" fill="#F2A62C" radius={[2, 2, 0, 0]} barSize={6} />
            <Bar dataKey="patients" name="Patients" fill="#0EA5E9" radius={[2, 2, 0, 0]} barSize={6} />
          </BarChart>
        </ResponsiveContainer>
      </Box>
    </Paper>
